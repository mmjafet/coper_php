...
<body>
    ...
    ?>
        ...
        <form action="./Eproveedor.php" method="post">
            ...
            <input name="txtTel" class="form-control" type="text" id="txtTel" value="<?php echo $datPre[2] ?>">
    ...
    <?php
        if(isset($_REQUEST['Registrar'])){
            ...
            $tel = $_POST['txtTel'];
            include("../conexion/conectar-mysql.php");
            echo $sql = "CALL edit_proveedor($id,'$nom','$tel')";
            $ejecConsulta = mysqli_query($conexion,$sql);
            if($ejecConsulta){
