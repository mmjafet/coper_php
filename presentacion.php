    ...
    <main class="d-flex flex-nowrap h-100">
        <div class="d-flex flex-column flex-shrink-0 p-4 sidebar bg-dark m-3">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="mb-1">
                    <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 text-white" data-bs-toggle="collapse" data-bs-target="#home-collapse" aria-expanded="true">
                        <i class="fas fa-chevron-down me-2 text-"></i> Características generales
                    </button>
                    <div class="collapse show" id="home-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            <li><a href="presentacion.php" class="link-body-emphasis d-inline-flex text-decoration-none rounded text-dark fw-bold bg-white">Presentación</a></li>
        ...
        <div class="content flex-grow-1 mt-4 p-4">
            <h2>Presentacion</h2>
            <a href='./Agregar/AgregarPresentacion.php' class='btn btn-primary mb-4' id=''>Agregar nuevo</a>
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                ...
                <tbody class="table-group-divider">
                    ...
                    $sql = 'SELECT * FROM presentacion WHERE status="1"';
                    // Ejecutar consulta
                    ...
                    while ($Pre = mysqli_fetch_array($ejecConsulta)) {
                        ...
                        <td>" . $Pre[1] . "</td>
                        <td>
                        <a href='./Editar/Epresentacion.php?id=" . $Pre[0] . "' class='btn btn-info mg-20'>Editar</a>
                        <a href='./Eliminar/Dpresent.php?id=" . $Pre[0] . "' class='btn btn-danger mg-20'>Eliminar</a>
                        </td>
                        </tr>";
                    }
