...
<body>
    ...
    <main class="d-flex flex-nowrap h-100">
                ...
                <li class="mb-1">
                    ...
                    <div class="collapse show" id="home-collapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            ...
                            <li><a href="categoria.php" class="link-body-emphasis d-inline-flex text-decoration-none rounded ttext-dark fw-bold bg-white">Categoría</a></li>
        ...
        <div class="content flex-grow-1 mt-4 p-4">
            <h2 >Categoria</h2>
            <a href='./Agregar/AgregarCategoria.php' class='btn btn-primary' id=''>Agregar nuevo</a>
            <table class="table">
            <thead>
                <tr>
                <th scope="col">#</th>
            ...
            <tbody class="table-group-divider">
                ...
                while($Pre = mysqli_fetch_array($ejecConsulta)){ 
                        ...
                        <td>" . $Pre[2] . "</td>
                        <td>
                        <a href='./Editar/Ecategoria.php?id=".$Pre[0]."' class='btn btn-info mg-20'>Editar</a>
                        <a href='./Eliminar/Dcategoria.php?id=".$Pre[0]."' class='btn btn-danger mg-20'>Eliminar</a>
